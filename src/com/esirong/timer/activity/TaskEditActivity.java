...
import com.esirong.timer.model.TaskType;
...
public class TaskEditActivity extends FragmentActivity implements
    ...
    private void showReminderDialog() {
        Calendar cal = Calendar.getInstance();
        if(mTask!=null&&mTask.getAlert_at()!=null){
            cal.setTimeInMillis( mTask.getAlert_at());  
        }
        ...
        timePicker.setOnDateTimeSetListener(new OnDateTimeSetListener() {
            ...
            public void OnDateTimeSet(AlertDialog dialog, long date) {
                ...
                Intent sender = new Intent(instance,
                        com.esirong.timer.receiver.AlarmReceiver.class);
                // sender.putExtra(AlarmAlertActivity.TASK_KEY, mTask.getId());
                PendingIntent pendingIntent = PendingIntent.getBroadcast(
                        instance, 0, sender, PendingIntent.FLAG_UPDATE_CURRENT);
    ...
    private void showEndTimeDialog() {
        Calendar cal = Calendar.getInstance();
        if(mTask!=null&&mTask.getEnd_at()!=null){
            cal.setTimeInMillis(mTask.getEnd_at());
        }
        DateTimePickerDialog timePicker = new DateTimePickerDialog(instance,
                cal.getTimeInMillis());
    ...
    private void showStartTimeDialog() {
        Calendar cal = Calendar.getInstance();
        if(mTask!=null&&mTask.getStart_at()!=null){
            cal.setTimeInMillis(mTask.getStart_at());
        }
        DateTimePickerDialog timePicker = new DateTimePickerDialog(instance,
                cal.getTimeInMillis());
